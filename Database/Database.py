...
class Database:
    ...
    def insert_main_table(self, top_stocks):
        ...
        for i, r in df.iterrows():
            try:
                sql = """
                        INSERT IGNORE INTO Main (Ticker, Last, Change_Percent, Change, Rating, Volume, Mkt_Cap, " \
                      "Price_to_Earnings, EPS, Employees, Sector) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                        ;"""
                val = (i, r['LAST'], r['CHG PERCENT'], r['CHG'], r['RATING'], r['VOL'], r['MKT CAP'], r['P_E'],
    ...
    def insert_valuation_table(self, top_stocks):
        ...
        for i, r in df.iterrows():
            try:
                ...
                val = (None, i, r['Market Capitalization'], r['Enterprise Value (MRQ)'], r['Enterprise Value/EBITDA (TTM)'],
    ...
    def insert_metrics_table(self, top_stocks):
        ...
        for i, r in df.iterrows():
            try:
                ...
                val = (None, i, r['Return on Assets (TTM)'], r['Return on Equity (TTM)'], r['Return on Invested Capital (TTM)'],
    ...
    def insert_balance_sheet_table(self, top_stocks):
        ...
        for i, r in df.iterrows():
            try:
                ...
                val = (None, i, r['Quick Ratio (MRQ)'], r['Current Ratio (MRQ)'], r['Debt to Equity Ratio (MRQ)'],
    ...
    def insert_price_history_table(self, top_stocks):
        ...
        for i, r in df.iterrows():
            try:
                ...
                val = (None, i, r['Average Volume (10 day)'], r['1-Year Beta'], r['52 Week High'], r['52 Week Low'])
                self.cur.execute(sql, val)
            except:
                pass
        self.con.commit()
    ...
    def insert_dividends_table(self, top_stocks):
        ...
        for i, r in df.iterrows():
            try:
                sql = "INSERT IGNORE INTO Dividends (ticker_id, Ticker, Dividends Paid, Dividends Yield, Dividends_per_Share) VALUES (%s, %s, %s, %s, %s)"
                val = (None, i, r['Dividends Paid (FY)'], r['Dividends Yield (FY)'], r['Dividends per Share (FY)'])
                self.cur.execute(sql, val)
            except:
                pass
        self.con.commit()
    ...
    def insert_margins_table(self, top_stocks):
        ...
        for i, r in df.iterrows():
            try:
                ...
                val = (None, i, r['Net Margin (TTM)'], r['Gross Margin (TTM)'], r['Operating Margin (TTM)'], r['Pretax Margin (TTM)'])
                self.cur.execute(sql, val)
            except:
                pass
        self.con.commit()
        ...
        for i, r in df.iterrows():
            try:
                sql = "INSERT IGNORE INTO Income (ticker_id, Ticker, Basic_EPS_FY, Basic_EPS_TTM, EPS_Diluted, Net_Income, " \
                  ...
                  " VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
                val = (None, i, r['Basic EPS (FY)'], r['Basic EPS (TTM)'], r['EPS Diluted (FY)'], r['Net Income (FY)'],
...
def create_tables(con):
    ...
    # sql = "INSERT INTO Main (None, Ticker, Last, Change_Percent, Change, Rating, Volume, Mkt_Cap, " \
    #       "Price_to_Earnings, EPS, Employees, Sector) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
...
#     create_tables(con)
#     db.insert_all_to_mysql(top_stocks, top_industries, top_sectors)
